...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container mx-auto px-5 py-10 md:py-16" }, _attrs))} data-v-cf9a2e31>`);
      _push(ssrRenderComponent(_sfc_main$1, {
        title: "Gallery - 14th Season Spring Summer 26 | Emirates Fashion Week",
        ...
        keywords: "Emirates Fashion Week Gallery, Fashion Week Photos, Runway Photos, Designer Collections, Dubai Fashion Week",
        "schema-type": "collection"
      }, null, _parent));
      _push(`<h1 class="text-3xl md:text-4xl xl:text-5xl mb-6" data-v-cf9a2e31>14th Season Spring Summer 26</h1><p class="text-base md:text-lg text-gray-700 mb-6" data-v-cf9a2e31> Statistics: Total 13 Photobanks. 10.000+ photo. 135+ TV interviews. 400+ Videos </p>`);
      if (tocItems.value.length) {
        _push(`<nav class="mb-10 md:mb-16 rounded-2xl border border-gray-200 bg-gray-50/80 p-4 md:p-6" data-v-cf9a2e31><p class="text-xs font-semibold uppercase tracking-widest text-gray-500 mb-4" data-v-cf9a2e31> Contents </p><ul class="flex flex-wrap gap-2" data-v-cf9a2e31><!--[-->`);
        ssrRenderList(tocItems.value, (item) => {
          _push(`<li data-v-cf9a2e31><a class="inline-flex items-center rounded-full border border-gray-300 bg-white px-3 py-1.5 text-sm text-gray-700 transition hover:border-black hover:text-black"${ssrRenderAttr("href", `#${item.id}`)} data-v-cf9a2e31>${ssrInterpolate(item.title)}</a></li>`);
        });
        _push(`<!--]--></ul></nav>`);
      } else {
        _push(`<!---->`);
      ...
      if (unref(isLoading)) {
        _push(`<div class="flex items-center justify-center py-10 text-gray-500" data-v-cf9a2e31> Loading galleries\u2026 </div>`);
      } else if (unref(errorMessage)) {
        _push(`<div class="flex flex-col items-center justify-center gap-4 py-10 text-center text-sm text-red-600" data-v-cf9a2e31><p data-v-cf9a2e31>\u041D\u0435 \u0443\u0434\u0430\u043B\u043E\u0441\u044C \u0437\u0430\u0433\u0440\u0443\u0437\u0438\u0442\u044C \u0433\u0430\u043B\u0435\u0440\u0435\u044E \u0438\u0437 Google Sheets.</p><p class="max-w-[480px] text-gray-500" data-v-cf9a2e31>${ssrInterpolate(unref(errorMessage))}</p><p class="text-gray-400" data-v-cf9a2e31>\u041F\u0440\u043E\u0432\u0435\u0440\u044C\u0442\u0435 \u0434\u043E\u0441\u0442\u0443\u043F\u043D\u043E\u0441\u0442\u044C \u0442\u0430\u0431\u043B\u0438\u0446\u044B \u0438 \u043F\u043E\u043F\u0440\u043E\u0431\u0443\u0439\u0442\u0435 \u043E\u0431\u043D\u043E\u0432\u0438\u0442\u044C \u0441\u0442\u0440\u0430\u043D\u0438\u0446\u0443.</p></div>`);
      } else {
        _push(`<div class="photographers-list space-y-12 md:space-y-16" data-v-cf9a2e31><!--[-->`);
        ssrRenderList(unref(photographers), (photographer, index) => {
          _push(`<section${ssrRenderAttr("id", getAnchorId(photographer, index))} class="scroll-mt-28" data-v-cf9a2e31>`);
...
const gallery = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-cf9a2e31"]]);

export { gallery as default };
//# sourceMappingURL=gallery-B4Ob1Gi6.mjs.map
