...
import { ref, computed, watch, nextTick, unref, mergeProps, useSSRContext } from 'vue';
import { _ as _sfc_main$3 } from './AppSeo-BjG2yXmh.mjs';
import { _ as __nuxt_component_0$1 } from './server.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { _ as _sfc_main$4 } from './WhatsAppButton-DIYmnQXx.mjs';
...
const fetchFaces = async () => {
  ...
  try {
    console.log("\u{1F504} \u0417\u0430\u0433\u0440\u0443\u0436\u0430\u0435\u043C \u0434\u0430\u043D\u043D\u044B\u0435 \u043B\u0438\u0446 \u0438\u0437 Google Sheets...");
    ...
    console.log("\u{1F4CA} \u041F\u043E\u043B\u0443\u0447\u0435\u043D\u044B \u0434\u0430\u043D\u043D\u044B\u0435 \u0438\u0437 Google Sheets:", rows);
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-3e87d75c><div class="flex justify-between items-center mb-8 xl:mb-[75px]" data-v-3e87d75c><h2 id="faces-of-efw" class="text-xl md:text-3xl xl:text-4xl md:text-left w-full text-center" data-v-3e87d75c>Faces of Emirates Fashion Week</h2><div class="flex items-center gap-4" data-v-3e87d75c><button class="w-6 h-6 md:w-10 md:h-10 flex items-center justify-center" aria-label="Previous faces" data-v-3e87d75c><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-3e87d75c><path d="M15 19L8 12L15 5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-3e87d75c></path></svg></button><button class="w-6 h-6 md:w-10 md:h-10 flex items-center justify-center" aria-label="Next faces" data-v-3e87d75c><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-3e87d75c><path d="M9 5L16 12L9 19" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-3e87d75c></path></svg></button></div></div>`);
      if (!isClient.value) {
        _push(`<div class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 xl:grid-cols-4 gap-4 md:gap-8" data-v-3e87d75c><!--[-->`);
        ssrRenderList(unref(facesData2), (person, index) => {
          _push(`<div class="face-card" data-v-3e87d75c><div class="bg-white rounded-2xl h-full relative overflow-hidden" data-v-3e87d75c><img${ssrRenderAttr("src", person.image)}${ssrRenderAttr("alt", `${person.name} - ${person.title}`)} class="w-full aspect-[4/5] rounded-lg object-cover" loading="lazy" data-v-3e87d75c>`);
          if (person.icon) {
            _push(`<div class="icon-ribbon" data-v-3e87d75c><span class="icon-ribbon__content" data-v-3e87d75c><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" data-v-3e87d75c><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" data-v-3e87d75c></path></svg> ICON of EFW </span></div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="p-4" data-v-3e87d75c><h3 class="text-lg font-semibold mb-1 text-center" data-v-3e87d75c>${ssrInterpolate(person.name)}</h3>`);
          if (person.title) {
            _push(`<div class="text-sm text-gray-800 text-center" data-v-3e87d75c>${ssrInterpolate(person.title)}</div>`);
          } else {
            _push(`<!---->`);
          }
          if (person.subtitle) {
            _push(`<div class="text-xs text-gray-500 text-center mb-4" data-v-3e87d75c>${ssrInterpolate(person.subtitle)}</div>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<div class="flex flex-wrap gap-1 md:gap-2 justify-center" data-v-3e87d75c><!--[-->`);
          ssrRenderList(person.links, (link, linkIndex) => {
            _push(`<a${ssrRenderAttr("href", link.url)} target="_blank" rel="noopener noreferrer" class="text-xs md:text-sm text-blue-600 hover:text-blue-800 underline" data-v-3e87d75c>${ssrInterpolate(link.text)}</a>`);
          });
...
const FacesOfEfwSection = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-3e87d75c"]]);
const _sfc_main$1 = {
  __name: "AiContestFaq",
  __ssrInlineRender: true,
  setup(__props) {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (selectedImage.value) {
        _push(`<div class="fixed inset-0 bg-black bg-opacity-75 flex items-center justify-center z-50 p-4" data-v-6b75023d><div class="relative max-w-4xl max-h-full" data-v-6b75023d><button class="absolute top-4 right-4 text-white text-2xl font-bold bg-black bg-opacity-50 rounded-full w-10 h-10 flex items-center justify-center hover:bg-opacity-75" data-v-6b75023d> \xD7 </button><img${ssrRenderAttr("src", selectedImage.value)} alt="Gallery Image" class="max-w-full max-h-full object-contain rounded-lg" data-v-6b75023d></div></div>`);
      } else {
        _push(`<!---->`);
      }
      _push(`</div>`);
...
export { EFW_AICONTEST as default };
//# sourceMappingURL=EFW_AICONTEST-FAHRWv-o.mjs.map
