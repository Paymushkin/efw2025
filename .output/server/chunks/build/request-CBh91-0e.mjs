...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container mx-auto px-4 py-4 md:py-6" }, _attrs))}>`);
...
//# sourceMappingURL=request-CBh91-0e.mjs.map
