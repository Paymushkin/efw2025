    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      _push(ssrRenderComponent(_component_NuxtLink, {
        ...
        default: withCtx((_, _push2, _parent2, _scopeId) => {
          if (_push2) {
            _push2(ssrRenderComponent(_sfc_main$4, { variant: "primary" }, {
...
const Station1 = "" + buildAssetsURL("station-1.C7LqaV28.png");
const Station2 = "" + buildAssetsURL("station-2.C0xPAZVE.png");
const Station3 = "" + buildAssetsURL("station-3.DiDw-w-i.png");
const sponsor4 = "" + buildAssetsURL("sponsor-logo.NspEgLtG.webp");
const EVENT_TYPES = {
  bigSponsorStation: {
...
const station1 = "" + buildAssetsURL("station-1.BNlqT-t_.webp");
const station3 = "" + buildAssetsURL("station-3.CHbwsq4R.webp");
const _sfc_main = {
  __name: "station",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=station-iiBUmapo.mjs.map
