...
import { ref, mergeProps, unref, withCtx, createVNode, toDisplayString, watch, useSSRContext } from 'vue';
...
import { _ as _sfc_main$4 } from './BaseButton-W8SaqIZj.mjs';
import { _ as _sfc_main$5 } from './ContactForm-C78zF6fE.mjs';
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.data) {
        ...
        if (__props.data.title) {
          _push(`<div class="mb-8 md:10 lg:mb-12"><div class="md:flex md:items-center"><h2${ssrRenderAttr("id", __props.data.id || "")} data-nosnippet class="text-2xl md:text-3xl lg:text-4xl"><a${ssrRenderAttr("href", __props.data.id ? `#${__props.data.id}` : "")} class="hover:opacity-80 transition-opacity">${(_a = __props.data.title || "") != null ? _a : ""}</a></h2>`);
...
//# sourceMappingURL=features-CRrf_WrB.mjs.map
