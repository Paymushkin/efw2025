...
import { ref, computed, watch, nextTick, unref, withCtx, createVNode, createBlock, createCommentVNode, openBlock, createTextVNode, toDisplayString, Fragment, renderList, mergeProps, useSSRContext } from 'vue';
...
const _sfc_main$2 = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<section${ssrRenderAttrs(_attrs)} data-v-d9dd65e2><div class="flex justify-between items-center mb-8 xl:mb-[75px]" data-v-d9dd65e2><h2 id="faces-of-efw" data-nosnippet class="text-xl md:text-3xl xl:text-4xl md:text-left w-full text-center" data-v-d9dd65e2>Faces of Emirates Fashion Week</h2><div class="flex items-center gap-4" data-v-d9dd65e2><button class="w-6 h-6 md:w-10 md:h-10 flex items-center justify-center" data-v-d9dd65e2><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-d9dd65e2><path d="M15 19L8 12L15 5" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-d9dd65e2></path></svg></button><button class="w-6 h-6 md:w-10 md:h-10 flex items-center justify-center" data-v-d9dd65e2><svg width="24" height="24" viewBox="0 0 24 24" fill="none" xmlns="http://www.w3.org/2000/svg" data-v-d9dd65e2><path d="M9 5L16 12L9 19" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" data-v-d9dd65e2></path></svg></button></div></div><div class="overflow-x-auto hide-scrollbar md:px-0" data-v-d9dd65e2>`);
            ...
            ssrRenderList(unref(facesData2), (person, index) => {
              _push2(ssrRenderComponent(unref(SwiperSlide), { key: index }, {
                default: withCtx((_2, _push3, _parent3, _scopeId2) => {
                  if (_push3) {
                    _push3(`<div class="bg-white rounded-2xl h-full relative overflow-hidden" data-v-d9dd65e2${_scopeId2}><img${ssrRenderAttr("src", person.image)}${ssrRenderAttr("alt", person.name)} class="w-full aspect-[4/5] rounded-lg object-cover"${ssrRenderAttr("loading", index === 0 ? "eager" : "lazy")} data-v-d9dd65e2${_scopeId2}>`);
                    if (person.icon) {
                      _push3(`<div class="icon-ribbon" data-v-d9dd65e2${_scopeId2}><span class="icon-ribbon__content" data-v-d9dd65e2${_scopeId2}><svg class="w-4 h-4" fill="currentColor" viewBox="0 0 24 24" data-v-d9dd65e2${_scopeId2}><path d="M12 2l3.09 6.26L22 9.27l-5 4.87 1.18 6.88L12 17.77l-6.18 3.25L7 14.14 2 9.27l6.91-1.01L12 2z" data-v-d9dd65e2${_scopeId2}></path></svg> ICON of EFW </span></div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<div class="p-4" data-v-d9dd65e2${_scopeId2}><h3 class="text-lg font-semibold mb-1 text-center" data-v-d9dd65e2${_scopeId2}>${ssrInterpolate(person.name)}</h3>`);
                    if (person.title) {
                      _push3(`<div class="text-sm text-gray-800 text-center" data-v-d9dd65e2${_scopeId2}>${ssrInterpolate(person.title)}</div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    if (person.subtitle) {
                      _push3(`<div class="text-xs text-gray-500 text-center mb-4" data-v-d9dd65e2${_scopeId2}>${ssrInterpolate(person.subtitle)}</div>`);
                    } else {
                      _push3(`<!---->`);
                    }
                    _push3(`<div class="flex flex-wrap gap-1 md:gap-2 justify-center" data-v-d9dd65e2${_scopeId2}><!--[-->`);
                    ssrRenderList(person.links, (link, linkIndex) => {
                      _push3(`<a${ssrRenderAttr("href", link.url)} target="_blank" class="text-xs md:text-sm text-blue-600 hover:text-blue-800 underline" data-v-d9dd65e2${_scopeId2}>${ssrInterpolate(link.text)}</a>`);
                    });
                    _push3(`<!--]--></div></div></div>`);
                  } else {
                    return [
...
const FacesOfEfwSection = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-d9dd65e2"]]);
const _sfc_main$1 = {
  __name: "AiContestFaq",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=EFW_AICONTEST-CWIjJp00.mjs.map
