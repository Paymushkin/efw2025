...
import { I as InstagramIcon } from './InstagramIcon-BfogBQdu.mjs';
import { _ as _export_sfc } from './_plugin-vue_export-helper-1tPrXgE0.mjs';
import { b as useRuntimeConfig } from './server.mjs';

const photo19 = "" + buildAssetsURL("photo-7-1.CU1kI3J3.webp");
const photo22 = "" + buildAssetsURL("photo-8-1.D3_-2gew.webp");
const photo34 = "" + buildAssetsURL("photo-12-1.BGNhMLN_.webp");
const _sfc_main = {
...
const photo1 = "" + buildAssetsURL("photo-1-1.1OOLMoCP.webp");
const photo2 = "" + buildAssetsURL("photo-1-2.MK22AT4S.webp");
const photo3 = "" + buildAssetsURL("photo-1-3.9z0ZBNE4.webp");
const photo4 = "" + buildAssetsURL("photo-2-1.DHAG0YGP.webp");
const photo5 = "" + buildAssetsURL("photo-2-2.BerCoi1z.webp");
const photo6 = "" + buildAssetsURL("photo-2-3.DmZbNXwt.webp");
const photo7 = "" + buildAssetsURL("photo-3-1.BX49Ce0J.webp");
const photo8 = "" + buildAssetsURL("photo-3-2.an515QQu.webp");
const photo9 = "" + buildAssetsURL("photo-3-3.BXgCFzvb.webp");
const photo10 = "" + buildAssetsURL("photo-4-1.sfbIK9Cg.webp");
const photo11 = "" + buildAssetsURL("photo-4-2.CSmUUwOW.webp");
const photo12 = "" + buildAssetsURL("photo-4-3.021R2wph.webp");
const photo13 = "" + buildAssetsURL("photo-5-1.hhPEHS1d.webp");
const photo14 = "" + buildAssetsURL("photo-5-2.Bn3tCYL9.webp");
const photo15 = "" + buildAssetsURL("photo-5-3.DLbW-XLU.webp");
const photo16 = "" + buildAssetsURL("photo-6-1.De3vLQ2A.webp");
const photo17 = "" + buildAssetsURL("photo-6-2.K84MqXvS.webp");
const photo18 = "" + buildAssetsURL("photo-6-3.D6e1Kx9z.webp");
const photo20 = "" + buildAssetsURL("photo-7-2.BKclwl_3.webp");
const photo21 = "" + buildAssetsURL("photo-7-3.B25uzyLR.webp");
const photo23 = "" + buildAssetsURL("photo-8-2.3uQEW8aS.webp");
const photo24 = "" + buildAssetsURL("photo-8-3.7dFTd6us.webp");
const photo25 = "" + buildAssetsURL("photo-9-1.VTAPS-86.webp");
const photo26 = "" + buildAssetsURL("photo-9-2.CyaNQ1j1.webp");
const photo27 = "" + buildAssetsURL("photo-9-3.5q6XnasF.webp");
const photo28 = "" + buildAssetsURL("photo-10-1.CYOcab9R.webp");
const photo29 = "" + buildAssetsURL("photo-10-2.B_Dh1oc2.webp");
const photo30 = "" + buildAssetsURL("photo-10-3.BUlxqy2j.webp");
const photo31 = "" + buildAssetsURL("photo-11-1.Bk-zVyxo.webp");
const photo32 = "" + buildAssetsURL("photo-11-2.CzOC__Mm.webp");
const photo33 = "" + buildAssetsURL("photo-11-3.DzjixgD5.webp");
const photo35 = "" + buildAssetsURL("photo-12-2.CLAsV4NH.webp");
const photo36 = "" + buildAssetsURL("photo-12-3.Cl2f9JFX.webp");
const photo37 = "" + buildAssetsURL("photo-13-1.DAJGc3Bp.webp");
const photo38 = "" + buildAssetsURL("photo-13-2.1zbjp112.webp");
const photo39 = "" + buildAssetsURL("photo-13-3.DeSk1fSx.webp");
const photo40 = "" + buildAssetsURL("photo-14-1.pCobPYv6.webp");
const photo41 = "" + buildAssetsURL("photo-14-2.DQonrLes.webp");
const photo42 = "" + buildAssetsURL("photo-14-3._XsLVdmj.webp");
const photo43 = "" + buildAssetsURL("photo-15-1.Djndh-CK.webp");
const photo44 = "" + buildAssetsURL("photo-15-2.C4MZwuxa.webp");
const photo45 = "" + buildAssetsURL("photo-15-3.GWakTCS0.webp");
const photo46 = "" + buildAssetsURL("photo-16-1.B_uacj4S.webp");
const photo47 = "" + buildAssetsURL("photo-16-2.DEgBFlK5.webp");
const photo48 = "" + buildAssetsURL("photo-16-3.CBzZMCvT.webp");
const photo49 = "" + buildAssetsURL("photo-17-1.B4KuB0ju.webp");
const photo50 = "" + buildAssetsURL("photo-17-2.CKq1QsDn.webp");
const photo51 = "" + buildAssetsURL("photo-17-3.vD3_c5-p.webp");
const photo52 = "" + buildAssetsURL("photo-18-1.C1ZTge5J.webp");
const photo53 = "" + buildAssetsURL("photo-18-2.Cwqbm-kq.webp");
const photo54 = "" + buildAssetsURL("photo-18-3.sVHO3fcF.webp");
const photo55 = "" + buildAssetsURL("photo-19-1.Bmnz6hM7.webp");
const photo56 = "" + buildAssetsURL("photo-19-2.BTp_TW6w.webp");
const photo57 = "" + buildAssetsURL("photo-19-3.C1bWlXun.webp");
const photo58 = "" + buildAssetsURL("photo-20-1.CxvnIOFp.webp");
const photo59 = "" + buildAssetsURL("photo-20-2.CjQPR2Ex.webp");
const photo60 = "" + buildAssetsURL("photo-20-3.CN1T8eBn.webp");
const photo61 = "" + buildAssetsURL("photo-21-1.g3X5Kh8H.webp");
const photo62 = "" + buildAssetsURL("photo-21-2.Bit6evVW.webp");
const photo63 = "" + buildAssetsURL("photo-21-3.CyT8uQjx.webp");
const photo64 = "" + buildAssetsURL("photo-22-1.BCDHeb45.webp");
const photo65 = "" + buildAssetsURL("photo-22-2.BCB0jOu3.webp");
const photo66 = "" + buildAssetsURL("photo-22-3.DZ34HcLh.webp");
const photo67 = "" + buildAssetsURL("photo-23-1.B2Za0S8O.webp");
const photo68 = "" + buildAssetsURL("photo-23-2.OQJ0ZqR2.webp");
const photo69 = "" + buildAssetsURL("photo-23-3.ChrVfyA4.webp");
const photo70 = "" + buildAssetsURL("photo-24-1.BONrY7CO.webp");
const photo71 = "" + buildAssetsURL("photo-24-2.pVM6XpCO.webp");
const photo72 = "" + buildAssetsURL("photo-24-3.BbdNYaTY.webp");
const photo73 = "" + buildAssetsURL("photo-25-1.CTBPAXuo.webp");
const photo74 = "" + buildAssetsURL("photo-25-2.bPWmSZBw.webp");
const photo75 = "" + buildAssetsURL("photo-25-3.CtlDCjcX.webp");
const photo76 = "" + buildAssetsURL("photo-26-1.nzxJconE.webp");
const photo77 = "" + buildAssetsURL("photo-26-2.DpBaWEHx.webp");
const photo78 = "" + buildAssetsURL("photo-26-3.Bsp45Wsf.webp");
const photo79 = "" + buildAssetsURL("photo-27-1.7ri-eaK1.webp");
const photo80 = "" + buildAssetsURL("photo-27-2.CLMcewcT.webp");
const photo81 = "" + buildAssetsURL("photo-27-3.BTcsDc3J.webp");
const photo82 = "" + buildAssetsURL("photo-28-1.BtzV35py.webp");
const photo83 = "" + buildAssetsURL("photo-28-2.CcrWi_Pn.webp");
const photo84 = "" + buildAssetsURL("photo-28-3.D9lzEmMJ.webp");
const photo85 = "" + buildAssetsURL("photo-29-1.CYKTq32_.webp");
const photo86 = "" + buildAssetsURL("photo-29-2.DAOvK5z0.webp");
const photo87 = "" + buildAssetsURL("photo-29-3.2rve-C7p.webp");
const photo88 = "" + buildAssetsURL("photo-30-1.1vruYHtp.webp");
const photo89 = "" + buildAssetsURL("photo-30-2.DvcDIHsC.webp");
const photo90 = "" + buildAssetsURL("photo-30-3.__eDVBbJ.webp");
const photo91 = "" + buildAssetsURL("photo-31-1.Cirf0192.webp");
const photo92 = "" + buildAssetsURL("photo-31-2.D8SVlDml.webp");
const photo93 = "" + buildAssetsURL("photo-31-3.ySuAOKRI.webp");
const photo94 = "" + buildAssetsURL("photo-32-1.WFBKDV4x.webp");
const photo95 = "" + buildAssetsURL("photo-32-2.CIwcBKah.webp");
const photo96 = "" + buildAssetsURL("photo-32-3.B61-BTuu.webp");
const photo97 = "" + buildAssetsURL("photo-33-1.DuXVJeE5.webp");
const photo98 = "" + buildAssetsURL("photo-33-2.DcS1T6DF.webp");
const photo99 = "" + buildAssetsURL("photo-33-3.BoYAiRxn.webp");
const photo100 = "" + buildAssetsURL("photo-34-1.xc326hgH.webp");
const photo101 = "" + buildAssetsURL("photo-34-2.C__JdbfA.webp");
const photo102 = "" + buildAssetsURL("photo-34-3.DqUuFAX6.webp");
const photo103 = "" + buildAssetsURL("photo-35-1.Bbt23iyl.webp");
const photo104 = "" + buildAssetsURL("photo-35-2.DB9V0hmZ.webp");
const photo105 = "" + buildAssetsURL("photo-35-3.nZGKDJkx.webp");
const photo106 = "" + buildAssetsURL("photo-36-1.BIPvWTJf.webp");
const photo107 = "" + buildAssetsURL("photo-36-2.Dzpfa3we.webp");
const photo108 = "" + buildAssetsURL("photo-36-3.pZU0eEj5.webp");
const photo109 = "" + buildAssetsURL("photo-37-1.DsjQ41RX.webp");
const photo110 = "" + buildAssetsURL("photo-37-2.bhB2FBxh.webp");
const photo111 = "" + buildAssetsURL("photo-37-3.sLMWkBuG.webp");
const photo112 = "" + buildAssetsURL("photo-38-1.Dvto_mOA.webp");
const photo113 = "" + buildAssetsURL("photo-38-2.C0CNcEOL.webp");
const photo114 = "" + buildAssetsURL("photo-38-3.C1j2HC1k.webp");
const photo115 = "" + buildAssetsURL("photo-39-1.BgO8rnr3.webp");
const photo116 = "" + buildAssetsURL("photo-39-2.BE7sW3Rz.webp");
const photo117 = "" + buildAssetsURL("photo-39-3.C7GacFVK.webp");
const photo118 = "" + buildAssetsURL("photo-40-1.CurevqYe.webp");
const photo119 = "" + buildAssetsURL("photo-40-2.Cal9JTUA.webp");
const photo120 = "" + buildAssetsURL("photo-40-3.D4u0UeyX.webp");
const photo121 = "" + buildAssetsURL("photo-41-1.q9l_ZZnF.webp");
const photo122 = "" + buildAssetsURL("photo-41-2.Hp-SXwkT.webp");
const photo123 = "" + buildAssetsURL("photo-41-3.D0EcUldw.webp");
const photo124 = "" + buildAssetsURL("photo-42-1.DKOHKOVK.webp");
const photo125 = "" + buildAssetsURL("photo-42-2.Ce2csH9_.webp");
const photo126 = "" + buildAssetsURL("photo-42-3.DL1VBzP4.webp");
const photo127 = "" + buildAssetsURL("photo-43-1.Dp4TsIEg.webp");
const photo128 = "" + buildAssetsURL("photo-43-2.DRJsIwUc.webp");
const photo129 = "" + buildAssetsURL("photo-43-3.y7Zg00np.webp");
const photographers = [
  {
...
const usePhotographers = (options = {}) => {
  var _a;
  const initialData = (_a = options.initialData) != null ? _a : photographers;
  ...
  const buildSheetUrl = () => {
    var _a2, _b, _c;
    const sheetId = (_a2 = options.sheetId) != null ? _a2 : config.public.gallerySheetId;
    const gid = (_c = (_b = options.gid) != null ? _b : config.public.gallerySheetGid) != null ? _c : "0";
    if (!sheetId) {
      return "";
    }
  ...
  const fetchPhotographers = async () => {
    ...
    try {
      ...
      errorMessage.value = (error == null ? void 0 : error.message) || "Unknown error";
      photographersData.value = [...initialData];
    } finally {
...
export { PhotographerBlock as P, usePhotographers as u };
//# sourceMappingURL=usePhotographers-DFXChNEl.mjs.map
