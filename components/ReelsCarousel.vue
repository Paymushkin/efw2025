...
// Получаем видимые видео для текущего индекса
...
// Устанавливаем ref для видео элемента
...
// Определяем размер видео - все одинакового размера
const getVideoSize = (index) => {
  return 'w-[300px] h-[533px]' // Все видео одинакового размера 9:16
}

// Убрана функция isActiveVideo, так как автоплей отключен
...
// Убрана автопрокрутка - пользователь управляет каруселью вручную
