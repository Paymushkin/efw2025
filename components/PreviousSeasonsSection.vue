<template>
  <section class="container mx-auto">
    <h2 data-nosnippet class="text-xl md:text-3xl xl:text-4xl scroll-mt-[120px] md:scroll-mt-[100px] text-black">14 SEASONS</h2>
      <p class="text-sm md:text-base xl:text-xl mb-4 xl:mb-8 md:mb-6 text-black">collections</p>
      <div 
