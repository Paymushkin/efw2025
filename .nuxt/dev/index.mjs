...
import { createFetch, Headers as Headers$1 } from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/ofetch/dist/node.mjs';
import { fetchNodeRequestHandler, callNodeRequestHandler } from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/node-mock-http/dist/index.mjs';
import { prefixStorage } from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/nitropack/node_modules/unstorage/dist/index.mjs';
import { createStorage } from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/nuxt/node_modules/unstorage/dist/index.mjs';
import unstorage_47drivers_47fs from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/nuxt/node_modules/unstorage/drivers/fs.mjs';
import { digest } from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/ohash/dist/index.mjs';
import { klona } from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/klona/dist/index.mjs';
import defu, { defuFn, defu as defu$1, createDefu } from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/defu/dist/defu.mjs';
import { snakeCase } from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/scule/dist/index.mjs';
...
import { stringify, uneval } from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/devalue/index.js';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/vue/index.mjs';
import devalue from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/@nuxt/devalue/dist/devalue.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$2 } from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/pathe/dist/index.mjs';
import { createHead as createHead$1, propsToString, renderSSRHead } from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/unhead/dist/server.mjs';
import { DeprecationsPlugin, PromisesPlugin, TemplateParamsPlugin, AliasSortingPlugin } from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/unhead/dist/plugins.mjs';
import { walkResolver } from 'file:///Users/paymei/Documents/Development/github/efw2025/node_modules/unhead/dist/utils.mjs';

const serverAssets = [{"baseName":"server","dir":"/Users/paymei/Documents/Development/github/efw2025/server/assets"}];
...
storage.mount('root', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/paymei/Documents/Development/github/efw2025","watchOptions":{"ignored":[null]}}));
storage.mount('src', unstorage_47drivers_47fs({"driver":"fs","readOnly":true,"base":"/Users/paymei/Documents/Development/github/efw2025/server","watchOptions":{"ignored":[null]}}));
storage.mount('build', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/paymei/Documents/Development/github/efw2025/.nuxt"}));
storage.mount('cache', unstorage_47drivers_47fs({"driver":"fs","readOnly":false,"base":"/Users/paymei/Documents/Development/github/efw2025/.nuxt/cache"}));
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/paymei/Documents/Development/github/efw2025/.data/kv"}));
    ...
    "sitemaps": {
      "sitemap.xml": {
        ...
        "defaults": {
          "changefreq": "weekly",
          "priority": 0.8,
          "lastmod": "2026-01-20T13:00:45.983Z"
        },
        "include": [],
        "exclude": [
          "/dubaifw/**",
...
const _KLeMkfBKusA1uPl9gAXuLQN8F7l0e0soysY97JsELWs = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/paymei/Documents/Development/github/efw2025";

const appHead = {"meta":[{"name":"viewport","content":"width=device-width, initial-scale=1"},{"charset":"utf-8"},{"name":"color-scheme","content":"light"}],"link":[{"rel":"icon","type":"image/x-icon","href":"/favicon.ico?v=3"},{"rel":"apple-touch-icon","sizes":"180x180","href":"/apple-touch-icon.png?v=3"},{"rel":"icon","type":"image/png","sizes":"32x32","href":"/favicon-32x32.png?v=3"},{"rel":"icon","type":"image/png","sizes":"16x16","href":"/favicon-16x16.png?v=3"},{"rel":"manifest","href":"/site.webmanifest"}],"style":[],"script":[{"src":"https://www.googletagmanager.com/gtag/js?id=G-93881479ZC","async":true},{"type":"text/javascript","innerHTML":"window.dataLayer = window.dataLayer || []; function gtag(){dataLayer.push(arguments);} gtag('js', new Date()); gtag('config', 'G-93881479ZC');"},{"src":"https://cdn.jsdelivr.net/npm/lite-youtube-embed@0.3.0/src/lite-yt-embed.js","defer":true},{"type":"text/javascript","innerHTML":"(function(){document.documentElement.setAttribute('data-theme','light');document.documentElement.style.colorScheme='light';if(document.body){if(document.body.style.cursor==='crosshair'||getComputedStyle(document.body).cursor==='crosshair'){document.body.style.cursor='default';}document.body.style.setProperty('cursor','default','important');}})();"}],"noscript":[]};
...
const _X7OX2MrDcSZ3cIcxZP8rTKZyYL3s8zS0MEYCdtiU0 = (nitroApp) => {
...
const plugins = [
  _KLeMkfBKusA1uPl9gAXuLQN8F7l0e0soysY97JsELWs,
_X7OX2MrDcSZ3cIcxZP8rTKZyYL3s8zS0MEYCdtiU0,
...
const _JYaMJG = defineEventHandler(async (e) => {
  const siteConfig = useSiteConfig(e);
  const nitroOrigin = useNitroOrigin(e);
  const runtimeConfig = useRuntimeConfig(e);
...
const getServerEntry = () => import('file:///Users/paymei/Documents/Development/github/efw2025/.nuxt//dist/server/server.mjs').then((r) => r.default || r);
const getClientManifest = () => import('file:///Users/paymei/Documents/Development/github/efw2025/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_jCV7QP = () => Promise.resolve().then(function () { return companiesList_get$1; });
const _lazy_tB3uy2 = () => Promise.resolve().then(function () { return designers_get$1; });
const _lazy_00irtY = () => Promise.resolve().then(function () { return faq_get$1; });
const _lazy_Xg7TFC = () => Promise.resolve().then(function () { return sendEmail_post$1; });
const _lazy_4T7ekk = () => Promise.resolve().then(function () { return waitlist_post$1; });
const _lazy_YfoQUR = () => Promise.resolve().then(function () { return renderer$1; });
...
const companiesList_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: companiesList_get
}, Symbol.toStringTag, { value: 'Module' }));
...
const designers_get$1 = /*#__PURE__*/Object.freeze(/*#__PURE__*/Object.defineProperty({
  __proto__: null,
  default: designers_get
}, Symbol.toStringTag, { value: 'Module' }));
...
const faq_get = defineEventHandler(async (event) => {
  try {
    ...
    const dataLines = lines.length > 0 && lines[0].toLowerCase().includes("entry") ? lines.slice(1) : lines;
