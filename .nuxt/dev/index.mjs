...
import { getRequestDependencies, getPreloadLinks, getPrefetchLinks, createRenderer } from 'file:///Users/paymei/Documents/github/dubaifw/node_modules/vue-bundle-renderer/dist/runtime.mjs';
...
import { withQuery, joinURL, withTrailingSlash, parseURL, withoutBase, getQuery, joinRelativeURL } from 'file:///Users/paymei/Documents/github/dubaifw/node_modules/ufo/dist/index.mjs';
...
import { createStorage, prefixStorage } from 'file:///Users/paymei/Documents/github/dubaifw/node_modules/unstorage/dist/index.mjs';
...
import { consola } from 'file:///Users/paymei/Documents/github/dubaifw/node_modules/consola/dist/index.mjs';
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/paymei/Documents/github/dubaifw/node_modules/errx/dist/index.js';
import { isVNode, unref, version } from 'file:///Users/paymei/Documents/github/dubaifw/node_modules/vue/index.mjs';
...
const _qzsJpPcARo = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/paymei/Documents/github/dubaifw";
...
const _lazy_6d3cPm = () => Promise.resolve().then(function () { return sendEmail_post$1; });
const _lazy_mMQHqT = () => Promise.resolve().then(function () { return renderer$1; });
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/paymei/Documents/github/dubaifw/.data/kv","ignore":["**/node_modules/**","**/.git/**"]}));
...
const getClientManifest = () => import('file:///Users/paymei/Documents/github/dubaifw/.nuxt/dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
