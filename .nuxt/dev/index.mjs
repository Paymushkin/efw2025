...
import destr, { destr as destr$1 } from 'file:///Users/paymei/Documents/Development/github/dubaifw/node_modules/destr/dist/index.mjs';
...
import { createStorage } from 'file:///Users/paymei/Documents/Development/github/dubaifw/node_modules/nuxt/node_modules/unstorage/dist/index.mjs';
...
import { SourceMapConsumer } from 'file:///Users/paymei/Documents/Development/github/dubaifw/node_modules/source-map/source-map.js';
...
import { captureRawStackTrace, parseRawStackTrace } from 'file:///Users/paymei/Documents/Development/github/dubaifw/node_modules/errx/dist/index.js';
import { isVNode, toValue, isRef } from 'file:///Users/paymei/Documents/Development/github/dubaifw/node_modules/vue/index.mjs';
import { promises } from 'node:fs';
import { fileURLToPath } from 'node:url';
import { dirname as dirname$1, resolve as resolve$1 } from 'file:///Users/paymei/Documents/Development/github/dubaifw/node_modules/pathe/dist/index.mjs';
...
import { walkResolver } from 'file:///Users/paymei/Documents/Development/github/dubaifw/node_modules/unhead/dist/utils.mjs';
...
storage.mount('data', unstorage_47drivers_47fs({"driver":"fs","base":"/Users/paymei/Documents/Development/github/dubaifw/.data/kv"}));
...
const _r4G2m5vfSzScXlBASEa0LEhGId8axS21vFqkpP4aihM = (function(nitro) {
  nitro.hooks.hook("render:html", (htmlContext) => {
    htmlContext.head.push(`<script>${script}<\/script>`);
  });
});

const rootDir = "/Users/paymei/Documents/Development/github/dubaifw";
...
const _IMmmFqCpOqAo7MsnQSHaECKUpqYOYiq8ayqTOGS0 = (nitroApp) => {
...
const plugins = [
  _r4G2m5vfSzScXlBASEa0LEhGId8axS21vFqkpP4aihM,
...
const getClientManifest = () => import('file:///Users/paymei/Documents/Development/github/dubaifw/.nuxt//dist/server/client.manifest.mjs').then((r) => r.default || r).then((r) => typeof r === "function" ? r() : r);
...
const _lazy_wEkTzD = () => Promise.resolve().then(function () { return designers_get$1; });
