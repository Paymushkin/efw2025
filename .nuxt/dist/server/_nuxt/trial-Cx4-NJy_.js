import { reactive, ref, computed, mergeProps, useSSRContext, watch, unref, withCtx, createVNode } from "vue";
import { ssrRenderAttrs, ssrInterpolate, ssrRenderAttr, ssrRenderStyle, ssrIncludeBooleanAttr, ssrLooseContain, ssrLooseEqual, ssrRenderClass, ssrRenderList, ssrRenderComponent } from "vue/server-renderer";
...
const WaitlistForm = /* @__PURE__ */ _export_sfc(_sfc_main$2, [["__scopeId", "data-v-662ad707"]]);
const _sfc_main$1 = {
  ...
  setup(__props, { expose: __expose, emit: __emit }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "companies-list" }, _attrs))} data-v-f4bdcaa3>`);
      if (loading.value) {
        _push(`<div class="text-center py-8" data-v-f4bdcaa3><div class="inline-block animate-spin rounded-full h-8 w-8 border-b-2 border-black" data-v-f4bdcaa3></div></div>`);
      } else if (error.value) {
        _push(`<div class="text-center py-8" data-v-f4bdcaa3><p class="text-red-600" data-v-f4bdcaa3>Loading error: ${ssrInterpolate(error.value)}</p></div>`);
      } else if (companies.value.length === 0) {
        _push(`<div class="text-center py-8" data-v-f4bdcaa3><p class="text-gray-600" data-v-f4bdcaa3>No registered companies yet</p></div>`);
      } else {
        _push(`<div class="space-y-3" data-v-f4bdcaa3><h3 class="text-lg font-semibold mb-4" data-v-f4bdcaa3>COMPANIES APPLICATIONS (${ssrInterpolate(companies.value.length)})</h3><div class="space-y-3 pr-2" data-v-f4bdcaa3><!--[-->`);
        ssrRenderList(companies.value, (company, index) => {
          ...
          ])}" data-v-f4bdcaa3><div class="flex items-center gap-3 flex-1" data-v-f4bdcaa3><div class="flex-shrink-0 w-6 h-6 bg-gray-200 rounded-full flex items-center justify-center text-xs font-medium text-gray-600" data-v-f4bdcaa3>${ssrInterpolate(index + 1)}</div><div class="flex-1" data-v-f4bdcaa3><div class="flex items-center gap-2" data-v-f4bdcaa3><div class="font-medium text-gray-900" data-v-f4bdcaa3>${ssrInterpolate(maskCompanyName(company.companyName))}${ssrInterpolate(company.industry ? " | " + company.industry : "")}</div>`);
          if (isNewCompany(company)) {
            _push(`<span class="px-2 py-1 text-xs font-semibold text-green-700 bg-green-100 rounded-full" data-v-f4bdcaa3> NEW </span>`);
          } else {
            _push(`<!---->`);
          }
          _push(`<span class="${ssrRenderClass(getStatusLabelStyle(company.status).class)}" data-v-f4bdcaa3>${ssrInterpolate(getStatusLabelStyle(company.status).text)}</span></div></div></div></div>`);
        });
        _push(`<!--]--></div></div>`);
      }
      _push(`</div>`);
...
const CompaniesList = /* @__PURE__ */ _export_sfc(_sfc_main$1, [["__scopeId", "data-v-f4bdcaa3"]]);
const _sfc_main = {
  __name: "trial",
  __ssrInlineRender: true,
  setup(__props) {
...
//# sourceMappingURL=trial-Cx4-NJy_.js.map
