...
const _sfc_main = {
  ...
  setup(__props, { expose: __expose }) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      }, _attrs))} data-v-bf1ba201><h2 id="faq" data-nosnippet class="text-xl md:text-3xl xl:text-4xl mb-8 md:mb-12" data-v-bf1ba201>`);
      if (__props.standalone) {
        _push(`<a href="#faq" class="hover:opacity-80 transition-opacity" data-v-bf1ba201>Frequently Asked Questions</a>`);
      } else {
        _push(`<a href="#faq" class="hover:opacity-80 transition-opacity" data-v-bf1ba201>FREQUENTLY ASKED QUESTIONS</a>`);
      }
      _push(`</h2>`);
      if (loading.value) {
        _push(`<div class="flex justify-center items-center py-8" data-v-bf1ba201><div class="text-gray-500" data-v-bf1ba201>Loading Frequently Asked Questions...</div></div>`);
      } else if (error.value) {
        _push(`<div class="text-center py-8" data-v-bf1ba201><div class="text-red-500 mb-4" data-v-bf1ba201>Error loading Frequently Asked Questions: ${ssrInterpolate(error.value)}</div><button class="px-4 py-2 bg-blue-500 text-white rounded hover:bg-blue-600" data-v-bf1ba201> Retry </button></div>`);
      } else {
        _push(`<div class="flex flex-col gap-4" data-v-bf1ba201><!--[-->`);
        ssrRenderList(displayedItems.value, (item) => {
          _push(`<div${ssrRenderAttr("id", item.id)} data-v-bf1ba201><div class="border border-black cursor-pointer" data-v-bf1ba201><div class="${ssrRenderClass([{ "border-b border-black": openPanels.value[item.id] }, "w-full p-4 md:p-6 flex justify-between items-start hover:bg-gray-50"])}" data-v-bf1ba201><span class="text-base md:text-xl xl:text-2xl pr-8 text-left" data-v-bf1ba201>${ssrInterpolate(item.question)}</span><span class="${ssrRenderClass([{ "rotate-45": openPanels.value[item.id] }, "text-2xl transform transition-transform duration-300 flex-shrink-0"])}" data-v-bf1ba201>+</span></div><div style="${ssrRenderStyle(openPanels.value[item.id] ? null : { display: "none" })}" class="p-4 md:p-6 text-sm md:text-base xl:text-lg text-black-70 border-t border-black origin-top" data-v-bf1ba201>${ssrInterpolate(item.answer)}</div></div></div>`);
        });
        _push(`<!--]--></div>`);
      }
      _push(`</section>`);
...
const FaqSectionDynamic = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-bf1ba201"]]);
export {
  FaqSectionDynamic as F
};
//# sourceMappingURL=FaqSectionDynamic-y7bg5agB.js.map
