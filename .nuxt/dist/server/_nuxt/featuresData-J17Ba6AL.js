import { ref, watch, mergeProps, useSSRContext, withCtx, createVNode, toDisplayString } from "vue";
...
import { _ as _sfc_main$2 } from "./BaseButton-W8SaqIZj.js";
    ...
    return (_ctx, _push, _parent, _attrs) => {
      ...
      if (__props.data) {
        ...
        if (__props.data.title) {
          _push(`<div class="mb-8 md:10 lg:mb-12"><div class="md:flex md:items-center"><h2${ssrRenderAttr("id", __props.data.id || "")} class="text-2xl md:text-3xl lg:text-4xl"><a${ssrRenderAttr("href", __props.data.id ? `#${__props.data.id}` : "")} class="hover:opacity-80 transition-opacity">${(__props.data.title || "") ?? ""}</a></h2>`);
...
//# sourceMappingURL=featuresData-J17Ba6AL.js.map
