...
const _sfc_main = {
  ...
  setup(__props) {
    ...
    return (_ctx, _push, _parent, _attrs) => {
      _push(`<div${ssrRenderAttrs(mergeProps({ class: "container mx-auto px-5 py-10 md:py-16" }, _attrs))} data-v-584fd506><h1 class="text-3xl md:text-4xl xl:text-5xl mb-10 md:mb-16" data-v-584fd506>14th Season Spring Summer 26</h1>`);
      if (unref(isLoading)) {
        _push(`<div class="flex items-center justify-center py-10 text-gray-500" data-v-584fd506> Loading galleries… </div>`);
      } else if (unref(errorMessage)) {
        _push(`<div class="flex flex-col items-center justify-center gap-4 py-10 text-center text-sm text-red-600" data-v-584fd506><p data-v-584fd506>Не удалось загрузить галерею из Google Sheets.</p><p class="max-w-[480px] text-gray-500" data-v-584fd506>${ssrInterpolate(unref(errorMessage))}</p><p class="text-gray-400" data-v-584fd506>Проверьте доступность таблицы и попробуйте обновить страницу.</p></div>`);
      } else {
        _push(`<div class="photographers-list space-y-12 md:space-y-16" data-v-584fd506><!--[-->`);
...
const gallery = /* @__PURE__ */ _export_sfc(_sfc_main, [["__scopeId", "data-v-584fd506"]]);
export {
  gallery as default
};
//# sourceMappingURL=gallery-BXwNQm_H.js.map
